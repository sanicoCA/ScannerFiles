...
//<s1>::= [CONNECTOR#getEword##gen#]<noun>#getEword#SUBJECT#gen#<afterSUBJECT>
void s1()
{
  if(traceON)
...
//<afterNOUN>::= <be>#gen#PERIOD | DESTINATION#gen#<verb>#getEword##gen#<tense>#gen#PERIOD | OBJECT#gen#[<noun>#getEword#DESTINATION#gen#]<verb>#getEword##gen#<tense>#gen#PERIOD
void afterNOUN()
{
  if(traceON)
